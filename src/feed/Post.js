    ...
    return (
        <div className="Post">
            <div className="post-Avatar">
                <Avatar src="https://lh3.googleusercontent.com/ogw/ADGmqu-K90yT3aVmevS-F5iodqbhyqfVIJlRA9GYFZ_Z=s83-c-mo" className="post_Avatar"/>
            </div>
            <div className="post_body">
                <div className="post_header">
                    <div className="post-header-text">
                        <h3>Khasan{" "}<span className="post_name_header"> <VerifiedUser className="post_badge"/>@khasan</span></h3>
                    </div>
